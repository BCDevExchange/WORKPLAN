...
$dataSourceRecordPermissions = array('project' => new DataSourceRecordPermission('staff_id', true, false, false, true, true, true),
  ...
  'timesheet' => new DataSourceRecordPermission('staff_id', false, false, false, true, true, true),
  ...
  'View Pay Period' => new DataSourceRecordPermission('staff_id', false, false, false, true, false, false),
...
'project.ProjectView' => 'View all Projects.Performance Charts',
...
'View Pay Period' => 'View Pay Period',
...
function SetUpUserAuthorization()
{
    ...
    $userAuthorizationStrategy = new TableBasedUserAuthorization(new UserIdentitySessionStorage(GetIdentityCheckStrategy()), new MyConnectionFactory(), GetGlobalConnectionOptions(), 'staff', 'username', 'staff_id', $grantsManager);
