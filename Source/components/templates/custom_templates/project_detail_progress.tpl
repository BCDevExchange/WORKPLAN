    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Project', 'Actual Progress', 'Total'],
        {/literal}
        {foreach item=Row from=$DataGrid.Rows name=RowsGrid}
            ['{$Row.DataCells.project_name.Data}', {$Row.DataCells.progress.Data}, {$Row.DataCells.assigned_progress.Data}]
        {/foreach}
        {literal}
        ]);
...
{/literal}
 ...
 {/foreach}
		...
		var formatter = new google.visualization.NumberFormat({ postfix: '%'});
