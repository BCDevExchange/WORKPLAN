...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'custom_templates/pay_period.tpl', 2, false),array('modifier', 'escape', 'custom_templates/pay_period.tpl', 9, false),array('modifier', 'escapeurl', 'custom_templates/pay_period.tpl', 10, false),array('function', 'jsbool', 'custom_templates/pay_period.tpl', 10, false),array('function', 'jsstring', 'custom_templates/pay_period.tpl', 304, false),array('block', 'style_block', 'custom_templates/pay_period.tpl', 11, false),)), $this); ?>
<!--<h3> 14 day period From: <?php echo ((is_array($_tmp="-14 days")) ? $this->_run_mod_handler('date_format', true, $_tmp, "%A, %B %e, %Y") : smarty_modifier_date_format($_tmp, "%A, %B %e, %Y")); ?>
   to &#10145;  <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%A, %B %e, %Y") : smarty_modifier_date_format($_tmp, "%A, %B %e, %Y")); ?>
</h3> <br/>-->

<b><a class="calendar_tooltip" href="#">( Pay Period Calendar )<span class="classic"><IMG src="images/calendar_pay.png" align=absMiddle></span></a><br/><p></b>
<table
...
<b>Generated on: <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%c") : smarty_modifier_date_format($_tmp, "%c")); ?>
</b><br />