...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'custom_templates/project_edit.tpl', 3, false),array('modifier', 'string_format', 'custom_templates/project_edit.tpl', 38, false),)), $this); ?>
<br />

<a href="ical.php?startdate=<?php echo ((is_array($_tmp=$this->_tpl_vars['Grid']['Columns']['date_start']['Value'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y%m%d') : smarty_modifier_date_format($_tmp, '%Y%m%d')); ?>
&enddate=<?php echo ((is_array($_tmp=$this->_tpl_vars['Grid']['Columns']['date_end']['Value'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y%m%d') : smarty_modifier_date_format($_tmp, '%Y%m%d')); ?>
&projectname=<?php echo $this->_tpl_vars['Grid']['Columns']['project_name']['Value']; ?>
&details=<?php echo $this->_tpl_vars['Grid']['Columns']['project_name']['Value']; ?>
&description=<?php echo $this->_tpl_vars['Grid']['Columns']['notes']['Value']; ?>
...
<div class="page-header form-header">
   <h1><?php echo $this->_tpl_vars['Grid']['Columns']['project_name']['Value']; ?>
</h1>
</div>
